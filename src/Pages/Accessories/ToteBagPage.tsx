// src/Pages/Accessories/ToteBag.tsx
...
export default function ToteBagPage() {
  ...
  const handleAddToCart = (item: ToteBag) => {
  ...
  const filteredItems: ToteBag[] = toteBags.filter((item) => {
    const categoryMatch =
  ...
  const sortedItems: ToteBag[] = [...filteredItems].sort((a, b) => {
    switch (sortOption) {
  ...
  return (
    <div className="min-h-screen relative">
      ...
      <div
        ...
        style={{
          backgroundImage: "url('/toteBags/banner.jpg')",
