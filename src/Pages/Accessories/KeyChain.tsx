...
export default function KeyChainPage() {
  ...
  const handleAddToCart = (item: KeyChain) => {
  ...
  const filteredItems: KeyChain[] = keyChains.filter((item) => {
    const categoryMatch =
  ...
  const sortedItems: KeyChain[] = [...filteredItems].sort((a, b) => {
    switch (sortOption) {
