...
export default function WomenAccessories() {
  ...
  const categories = [...new Set(womenAccessories.map((item) => item.category))];

  const filteredItems: WomenAccessory[] = womenAccessories.filter((item) => {
    const categoryMatch =
  ...
  const sortedItems: WomenAccessory[] = [...filteredItems].sort((a, b) => {
    switch (sortOption) {
  ...
  return (
    <div className="min-h-screen relative">
      ...
      <div
        ...
        style={{
          backgroundImage: "url('/accessories/banner.jpg')",
      ...
      >
        ...
        >
          Stylish and elegant accessories for modern women.
        </motion.p>
      </div>

      <div className="max-w-7xl mx-auto px-6 sm:px-10 mt-16 grid grid-cols-1 md:grid-cols-5 gap-8">
        {/* Sidebar */}
        <aside className="md:col-span-1 bg-white p-4 h-[430px] rounded-lg shadow mt-2">
          <div className="mb-6">
                  ...
                  <div className="w-full max-w-[360px] flex flex-col">
                    ...
                    <div className="mt-4 text-center">
                      ...
                      <div className="mt-2 flex justify-center gap-3 items-baseline">
                        <span className="text-2xl text-[#8B5E3C] font-cinzel">₹{item.price}</span>
                      </div>
                    </div>
                  </div>
                </motion.div>
