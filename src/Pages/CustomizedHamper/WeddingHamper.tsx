...
import { useCart } from "../../AuthContext/CartContext"; // centralized cart context

export default function WeddingHamper() {
  ...
  // Filter hampers
  const filteredHampers = weddingHampers.filter((item) => {
    const categoryMatch =
    ...
    switch (highlight) {
      case "Best Seller":
        ...
        break;
      case "New Arrival":
        highlightMatch = item.newArrival ?? false;
        break;
      default:
        highlightMatch = true;
    }
