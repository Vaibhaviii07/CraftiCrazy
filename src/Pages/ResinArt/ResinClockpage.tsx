// src/Pages/ResinArt/ResinClockPage.tsx
...
export default function ResinClockPage() {
  ...
  const filteredItems = useMemo(() => {
    return resinClocks.filter((item: ResinClock) => {
      const categoryMatch =
    ...
    <section className="min-h-screen bg-gray-50">
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 md:px-10 mt-4 grid md:grid-cols-5 gap-6">
        ...
        {(showFilters || isDesktop) && (
          <aside className="md:col-span-1 bg-white h-fit p-4 rounded-lg shadow mb-4 md:mb-0">
            {/* Categories */}
            <div className="mb-6">
        ...
        <div className="md:col-span-4 flex flex-col gap-6">
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-4 mb-16">
            <AnimatePresence>
              {sortedItems.map((item: ResinClock) => (
                <motion.div
                  key={item.id}
