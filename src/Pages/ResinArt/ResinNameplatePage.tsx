...
export default function ResinNameplatePage() {
  ...
  const filteredItems = resinNameplates.filter((item) => {
    const categoryMatch =
  ...
  return (
    <div className="bg-gray-50 min-h-screen">
      ...
      <div
        ...
        style={{
          backgroundImage: "url('/resinnameplates/banner.jpg')",
      ...
      >
        ...
        >
          Unique handcrafted resin nameplates for your home, office, or gifts.
        </motion.p>
      </div>
