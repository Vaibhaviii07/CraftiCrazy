// src/Pages/Accessories/ResinKeychainPage.tsx
...
export default function ResinKeychainPage() {
  ...
  const filteredItems = resinKeychains.filter((item) => {
    const categoryMatch =
    ...
    switch (highlight) {
      case "Best Seller":
        highlightMatch = item.popularity >= 85;
        break;
      case "Discounted":
  ...
  return (
    <div className="bg-gray-50 min-h-screen">
      ...
      <div
        ...
        style={{
          backgroundImage: "url('/resinkeychains/banner-keychain.jpg')",
      ...
      >
        ...
        >
          Discover our collection of handcrafted resin keychains — unique, stylish, and durable.
        </motion.p>
      </div>
