// src/Pages/ResinFrame/ResinFramePage.tsx
...
export default function ResinFramePage() {
  const [items, setItems] = useState<ResinFrame[]>(resinFrames); // fallback
  ...
  useEffect(() => {
    const fetchFrames = async () => {
      try {
        ...
        console.error("Resin Frames API fetch failed:", err.message);
                ...
                {sortedItems.map((item) => {
                  ...
                  return (
                    ...
                    >
                      ...
                      >
                        <div className="relative w-full h-[280px] sm:h-[320px] lg:h-[380px] rounded-2xl overflow-hidden shadow-md hover:shadow-xl transition-transform duration-300 hover:-translate-y-1">
                          <motion.img
                            src={item.image}
                            alt={item.name}
                            loading="lazy"
