// src/Pages/Accessories/WoodenPhotoFramesPage.tsx
import { useState } from "react";
import { motion, AnimatePresence } from "framer-motion";
import { Link } from "react-router-dom";
import { woodenFrames } from "../../Data/WoodenFramedata";

export default function WoodenPhotoFramesPage() {
  ...
  const filteredItems = woodenFrames.filter((item) => {
    const categoryMatch =
