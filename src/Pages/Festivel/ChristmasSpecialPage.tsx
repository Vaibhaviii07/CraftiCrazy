...
export default function ChristmasSpecialPage() {
  const [items, setItems] = useState<ChristmasSpecial[]>(christmasSpecials);
  ...
  useEffect(() => {
    const fetchItems = async () => {
      try {
        const res = await fetch("http://localhost:5000/api/christmasspecials");
        ...
        console.error("Christmas Specials API fetch failed:", err.message);
    ...
    <section className="min-h-screen ">
      ...
      <div className="text-center mt-10 mb-8 px-4">
        ...
        <p className="mt-3 text-gray-600 text-base italic max-w-sm mx-auto">
          Celebrate the joy of Christmas with our specially curated festive hampers.
        </p>
      </div>
