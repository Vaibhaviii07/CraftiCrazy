// src/Pages/Holi/HoliKitPage.tsx
...
export default function HoliKitPage() {
  const [items, setItems] = useState<HoliKit[]>(holiKits);
  ...
  useEffect(() => {
    const fetchKits = async () => {
      try {
        const res = await fetch("http://localhost:5000/api/holikits");
        ...
        console.error("Holi Kits API fetch failed:", err.message);
