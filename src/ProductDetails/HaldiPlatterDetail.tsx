// src/Pages/HaldiPlatter/HaldiPlatterDetailPage.tsx
...
export default function HaldiPlatterDetail() {
  ...
  const productFromParams: HaldiPlatter | undefined = haldiPlatters.find(
    (p) => String(p.id) === id
  );
  ...
  const [currentProduct] = useState<HaldiPlatter>(productFromParams);
