// src/Pages/ChristmasSpecialDetailPage.tsx
import { useParams } from "react-router-dom";
import { useState, useEffect, useMemo } from "react";
import { christmasSpecials, ChristmasSpecial, Variant } from "../Data/ChristmasSpecialdata";
...
export default function ChristmasSpecialDetail() {
  ...
  const [currentProduct, setCurrentProduct] = useState<ChristmasSpecial | null>(productFromParams ?? null);
  ...
  if (!currentProduct) {
    return <p className="text-center mt-20 text-lg text-gray-400">Christmas Special not found</p>;
  }
