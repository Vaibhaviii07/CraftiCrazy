        ...
        <div className="flex-1 flex flex-col gap-4 sm:gap-5">
          ...
          <div className="flex flex-wrap items-center gap-3 sm:gap-4">
            <div className="flex items-center gap-1">
              ...
              {currentProduct.reviews && <span className="text-gray-500 ml-2">({currentProduct.reviews} reviews)</span>}
            </div>
          ...
          {/* Highlight / Description / Brand / Seller */}
          {currentProduct.description && <p className="text-gray-700 leading-relaxed mt-1">{currentProduct.description}</p>}
          {currentProduct.brand && <p className="text-gray-700"><span className="font-semibold">Brand:</span> {currentProduct.brand}</p>}
          {currentProduct.seller && <p className="text-gray-700"><span className="font-semibold">Seller:</span> {currentProduct.seller}</p>}
