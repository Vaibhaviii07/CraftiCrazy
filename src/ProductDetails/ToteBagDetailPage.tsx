...
export default function ToteBagDetailPage() {
  ...
  const productFromParams: ToteBag | undefined = toteBags.find((b) => b.id.toString() === id);
  const [currentProduct, setCurrentProduct] = useState<ToteBag | null>(productFromParams ?? null);
