...
import { corporateHampers, CorporateHamper } from "../Data/CorporateData";
...
export default function CorporateHamperDetails() {
  ...
  const productFromParams = corporateHampers.find((p) => p.id === id);
  ...
  const similar = corporateHampers.filter(
          ...
          {currentProduct.contents?.length ? (
            ...
            {currentProduct.delivery && (
              <div>
                ...
                <p className="text-gray-600"><span className="font-medium">Type:</span> {currentProduct.delivery.type}</p>
                <p className="text-gray-600"><span className="font-medium">Availability:</span> {currentProduct.delivery.availability}</p>
                <p className="text-gray-600"><span className="font-medium">Estimated:</span> {currentProduct.delivery.estimated}</p>
              </div>
            )}
            ...
            {currentProduct.customization?.available && (
              <div>
                ...
                {currentProduct.customization.options?.length ? (
                  <ul className="list-disc list-inside text-gray-600 space-y-1">
