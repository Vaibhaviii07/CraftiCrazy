...
export default function WalletDetailPage() {
  ...
  if (!productFromParams && !loading)
    return <p className="text-center mt-20 text-lg text-gray-400">Wallet not found</p>;

  const [currentProduct, setCurrentProduct] = useState<Wallet | null>(productFromParams ?? null);
