  ...
  <div className="relative w-full max-w-lg">
    <input
      ...
      className="w-full rounded-full py-2.5 pl-5 pr-14 
                 ...
                 shadow-lg backdrop-blur-md text-black
    ...
    <div className="hidden md:flex items-center gap-6">
      <Link to="/login" className="text-black hover:text-yellow-200 transition transform hover:scale-110">
        <User size={22} />
      </Link>
      <Link to="/wishlist" className="text-black hover:text-yellow-200 transition transform hover:scale-110">
        <Heart size={22} />
      </Link>
      <Link to="/cart" className="text-black hover:text-yellow-200 transition relative transform hover:scale-110">
