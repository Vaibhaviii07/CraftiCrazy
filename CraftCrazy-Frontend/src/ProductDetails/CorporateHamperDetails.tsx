...
export default function CorporateHamperDetails() {
  ...
  const selectedVariant = useMemo<LocalVariant | null>(() => {
    ...
    const derivedId = (first && ((first as any).id ?? (first as any).variantId)) ?? `${currentProduct.id}-default`;
      ...
      <div className="flex flex-col lg:flex-row gap-8 lg:gap-12">
        ...
        <div className="flex-1 flex flex-col gap-4 sm:gap-5">
          ...
          <div className="flex flex-wrap gap-3 text-gray-500 text-sm sm:text-base mt-2">
            {currentProduct.tags?.map((tag: string, idx: number) => (
          ...
          <div className="mt-6 flex flex-col gap-4">
            ...
            {currentProduct.specifications && (
              <div className="bg-gray-50 p-3 rounded-md">
                ...
                <ul className="list-disc list-inside text-gray-600 space-y-1">
                  {Object.entries(currentProduct.specifications).map(([key, value]: [string, string], idx: number) => (
