...
export default function RakhiDetailPage() {
  ...
  const staticProduct = rakhiKits.find(p => String(p.id) === id);
  const [currentProduct, setCurrentProduct] = useState<RakhiKit | null>(staticProduct ?? null);
  ...
  // Default variant with guaranteed ID
